...
class TestSha1(unittest.TestCase):
    ...
    def test_similar(self):
        ...
        first_digest = lab3.sha1.sha1(bytes(first_msg))
        modified_digest = lab3.sha1.sha1(bytes(modified_msg))
    ...
    def test_repeatable(self):
        ...
        first_digest = lab3.sha1.sha1(bytes(msg))
        second_digest = lab3.sha1.sha1(bytes(msg))
    ...
    def test_comparison(self):
        ...
        custom_sha1_digest = lab3.sha1.sha1(bytes(msg))
    ...
    def test_associativity(self):
        ...
        first_digest = lab3.sha1.sha1(bytes(msg1) + bytes(msg2))

        sha = lab3.sha1.Sha1Hash()
        sha.update(msg1)
        sha.update(msg2)
